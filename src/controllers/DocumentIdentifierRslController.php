...
class DocumentIdentifierRslController extends Controller
{
    //public $layout = 'main';
    ...
    public function actionIndex()
    {
        ...
        $resourcesTypeSize = $render->getResourceApi()->resourcesTypeSize($identifierEntity, 'meta');
